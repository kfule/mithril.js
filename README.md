...
A modern client-side JavaScript framework for building Single Page Applications. It's small (<!-- size -->5.79 KB<!-- /size --> gzipped), fast and provides routing and XHR utilities out of the box.
